...
describe("parse", function () {
    ...
    it("can parse a floating point number in scientific notation", function () {
        var fn = parse('.42e2');
        expect(fn()).toBe(42);
    });
    it("can parse a number in scientific notation with negative exponent", function () {
        var fn = parse('4200e-2');
        expect(fn()).toBe(42);
    });
    it("can parse a number in scientific notation with positive exponent", function () {
        var fn = parse('.42e+2');
        expect(fn()).toBe(42);
    });
    it("can parse a number in scientific notation with capital E", function () {
        var fn = parse('.42E2');
        expect(fn()).toBe(42);
    });
